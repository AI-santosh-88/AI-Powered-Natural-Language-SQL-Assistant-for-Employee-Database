...
- Target database: SB_it_employee1.
- Table: SB_it_employee1.
...
A: SELECT COUNT(*) FROM SB_it_employee1

Q: Show all Data Engineers
A: SELECT * FROM SB_it_employee1 WHERE employee_role = 'Data Engineer'

Q: Who earns more than 60000?
A: SELECT * FROM SB_it_employee1 WHERE employee_salary > 60000

Q: Who earns the highest salary?
A: SELECT * FROM SB_it_employee1 ORDER BY employee_salary DESC LIMIT 1
...
st.title("Gemini SQL Assistant (SB IT DB)")
...
if st.button("Run"):
    if question.strip() == "":
        ...
        # Run SQL query
        result, columns = read_sql_query(sql_query, "SB_it_employee1.db")
